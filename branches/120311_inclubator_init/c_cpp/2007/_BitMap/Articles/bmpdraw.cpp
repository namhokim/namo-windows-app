...
#define BMP_ID            0x4D42      // BMP 파일의 식별자 
...
LPDIRECTDRAW7               lpDD = NULL;        // DirectDraw 객체
LPDIRECTDRAWSURFACE7    lpDDSPrimary = NULL; // DirectDraw 기본표면 객체
...
3. 위에서 보시면 알겠지만 프로그램 구동시키고, esc치믄 종료하는 프로그램입니다.

    그럼 윈메인에 있던 못보던 함수ProcessHere()를 한번 살펴보죠.
