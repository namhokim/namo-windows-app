...
//	MSG Message;
	...
	// 인터넷 연결
	hInternet=InternetOpen("HTTPACK", INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, 0);
	...
	hReq = HttpOpenRequest(hHttp,"POST",request,NULL,NULL,NULL,0,0);
